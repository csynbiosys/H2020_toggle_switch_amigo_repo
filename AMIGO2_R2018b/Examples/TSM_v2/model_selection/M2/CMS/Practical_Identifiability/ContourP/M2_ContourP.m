...
%============================
inputs.pathd.results_folder='M2'; % Folder to keep results (in Results) for a given problem
...
%==================================
 ...
 inputs.model.exe_type='standard';
  ...
  for iexp= 1:inputs.exps.n_exp
     ...
     inputs.exps.exp_y0{iexp}=[ToggleSwitch_M2_Compute_SteadyState(model.par,[1000,400],1,0) 0];
