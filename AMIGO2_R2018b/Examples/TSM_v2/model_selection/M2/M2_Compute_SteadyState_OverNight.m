function [InitialConditions]= M2_Compute_SteadyState_OverNight(epcc_exps,inputs,iexp,params,InitialExpData,IPTGe,aTce)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
newExps.exp_y0{1}=M2_Compute_SteadyState(params,InitialExpData,IPTGe,aTce);     
