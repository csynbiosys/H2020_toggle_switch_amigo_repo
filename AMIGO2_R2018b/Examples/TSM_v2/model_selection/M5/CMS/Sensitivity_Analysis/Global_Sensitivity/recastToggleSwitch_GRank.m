...
inputs.pathd.short_name='recastTSM_GRank';                       % To identify figures and reports for a given problem 
...
%==================================
 ...
 inputs.model.exe_type='standard';
  ...
  for iexp= 1:inputs.exps.n_exp
     ...
     inputs.exps.exp_y0{iexp}=[ToggleSwitch_M5_Compute_SteadyState(model.par,[1000,400],1,0) 0]; 
 end
