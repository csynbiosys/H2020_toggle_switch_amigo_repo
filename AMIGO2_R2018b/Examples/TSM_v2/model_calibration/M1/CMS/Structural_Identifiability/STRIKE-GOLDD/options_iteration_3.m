...
function [modelname,paths,opts,submodels,prev_ident_pars] = options_iteration_3()
...
opts.unidentif  = 1;       % use method to try to establish unidentifiability instead of identifiability, when using decomposition. 
