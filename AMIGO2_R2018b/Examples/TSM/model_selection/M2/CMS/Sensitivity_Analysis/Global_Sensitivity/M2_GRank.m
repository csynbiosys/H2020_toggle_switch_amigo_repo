...
%==================================
 exps.n_exp=13;                                 % Number of experiments   
...
inputs.PEsol.global_theta_min=global_theta_min(param_including_vector);%(1/2).*inputs.model.par(param_including_vector); %[0.1386,5e-06,1e-3,7000,1,2,2,0.0165,1e-05,0.001,700,3.07e-4,2,2,1.32,1,0.001,0.001,1.32,1,0.001,0.001]; % verify Theta_T is correct 
inputs.PEsol.global_theta_max=global_theta_max(param_including_vector);%2.*inputs.model.par(param_including_vector); %[0.1386,10,1000,7000,100,4,4,0.0165,30,1000,700,3.07e-2,4,4,1320,1000,0.1,0.1,1320,1000,0.1,0.1]; % Maximum allowed values for the parameters
