...
%============================
inputs.pathd.results_folder='M2_debug'; % Folder to keep results (in Results) for a given problem                       
inputs.pathd.short_name='M2_GRank';                       % To identify figures and reports for a given problem 
inputs.pathd.runident='run3';                         % [] Identifier required in order not to overwrite previous results
...
%==================================
 exps.n_exp=20;                                 % Number of experiments   
...
inputs.PEsol.global_theta_min=(1/2.5).*inputs.model.par; %[0.1386,5e-06,1e-3,7000,1,2,2,0.0165,1e-05,0.001,700,3.07e-4,2,2,1.32,1,0.001,0.001,1.32,1,0.001,0.001]; % verify Theta_T is correct 
inputs.PEsol.global_theta_max=2.5.*inputs.model.par; %[0.1386,10,1000,7000,100,4,4,0.0165,30,1000,700,3.07e-2,4,4,1320,1000,0.1,0.1,1320,1000,0.1,0.1]; % Maximum allowed values for the parameters
...
inputs.ivpsol.rtol=1e-7;                            % [] IVP solver integration tolerances
...
inputs.nlpsol.eSS.log_var = (1:18); 
