...
inputs.pathd.short_name='M4_RIdent';                       % To identify figures and reports for a given problem 
...
inputs.PEsol.global_theta_min=(1/2).*inputs.model.par(param_including_vector); 
inputs.PEsol.global_theta_max=2.*inputs.model.par(param_including_vector); 
