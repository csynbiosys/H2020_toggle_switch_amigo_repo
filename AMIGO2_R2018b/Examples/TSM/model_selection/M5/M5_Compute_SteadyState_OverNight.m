function [InitialConditions]= M5_Compute_SteadyState_OverNight(epcc_exps,inputs,iexp,params,InitialExpData,initial_u)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
newExps.exp_y0{1}=[M5_Compute_SteadyState(params,InitialExpData,initial_u)];     
