function [ res ] = ToggleSwitch_M5_Compute_SteadyState(theta, InitialStates_AU, u_IPTG, u_aTc )
% ToggleSwitch_M5_Compute_SteadyState computes the steady state of the MToggleSwitch model for the given values of
