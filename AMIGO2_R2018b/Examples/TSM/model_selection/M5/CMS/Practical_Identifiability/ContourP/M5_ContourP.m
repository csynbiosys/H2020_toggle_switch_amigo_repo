...
inputs.pathd.short_name='M5_ContourP';                       % To identify figures and reports for a given problem 
...
inputs.plotd.nx_contour=150;                          % Number of points for plotting the contours x and y direction
inputs.plotd.ny_contour=150;                          % ADVISE: >50
