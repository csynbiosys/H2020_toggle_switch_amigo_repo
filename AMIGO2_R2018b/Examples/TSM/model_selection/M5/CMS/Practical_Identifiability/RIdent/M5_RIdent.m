...
%============================
inputs.pathd.results_folder='M5'; % Folder to keep results (in Results) for a given problem                       
inputs.pathd.short_name='M5_RIdent';                       % To identify figures and reports for a given problem 
...
% Excluding parameters which are fixed and those which are not identifiable
