...
% unknown parameters
syms k_m0L k_m0T k_mL k_mT k_pL k_pT K_IPTG_theta_LacI...
     N_LacI N_IPTG K_aTc_theta_TetR N_TetR...
     N_aTc K_in_IPTG K_out_IPTG
...
% parameters:
p    = [k_m0L k_m0T k_mL k_mT k_pL k_pT K_IPTG_theta_LacI...
        N_LacI N_IPTG K_aTc_theta_TetR N_TetR...
        N_aTc K_in_IPTG K_out_IPTG].';
...
f    = [(K_in_IPTG*(IPTGext-IPTG)+((K_in_IPTG*(IPTGext-IPTG))^2)^0.5)/2-(K_out_IPTG*(IPTG-IPTGext)+((K_out_IPTG*(IPTG-IPTGext))^2)^0.5)/2; %max(K_in_IPTG*(IPTGext-IPTG),0.00)-fmax(K_out_IPTG*(IPTG-IPTGext),0.00);
        k_m0L+k_mL/(1+(TetR/(K_aTc_theta_TetR*(aTcext)^N_aTc))^N_TetR)-g_mL*mrna_LacI;
...
save('TSM_M5','x','h','u','p','f','ics','known_ics');