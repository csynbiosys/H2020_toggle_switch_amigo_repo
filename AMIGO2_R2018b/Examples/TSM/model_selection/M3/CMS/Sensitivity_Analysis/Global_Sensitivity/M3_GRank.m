...
%============================
inputs.pathd.results_folder='M3_ToggleSwitch2'; % Folder to keep results (in Results) for a given problem                       
inputs.pathd.short_name='M3_GRank';                       % To identify figures and reports for a given problem 
