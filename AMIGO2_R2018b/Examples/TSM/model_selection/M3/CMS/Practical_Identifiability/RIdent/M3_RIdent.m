...
inputs.pathd.short_name='M3_RIdent';                       % To identify figures and reports for a given problem 
inputs.pathd.runident='full-par-bound-run';                         % [] Identifier required in order not to overwrite previous results
...
global_theta_min=[0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,0.001,2,1,2,0.001,2,1,2,0.01,0.001];
global_theta_max=[1,1,100,100,10,100,100,100,100,100,1000,4,1000,4,100,4,100,4,100,100];
...
inputs.nlpsol.eSS.log_var = (1:10); 
