function [InitialConditions]= M3_Compute_SteadyState_OverNight(epcc_exps,inputs,iexp,params,InitialExpData,initial_u)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
newExps.exp_y0{1}=compute_steady_state(params,InitialExpData,initial_u);     
