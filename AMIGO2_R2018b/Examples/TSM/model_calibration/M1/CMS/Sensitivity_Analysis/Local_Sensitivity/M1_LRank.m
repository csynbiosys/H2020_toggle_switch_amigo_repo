...
%============================
inputs.pathd.results_folder='M1_ToggleSwitch'; % Folder to keep results (in Results) for a given problem                       
inputs.pathd.short_name='M1_LRank';                       % To identify figures and reports for a given problem 
...
%==================================
 exps.n_exp=23;                                 % Number of experiments   
...
for iexp=1:exps.n_exp
    ...
    Y0(iexp,:) = M1_Compute_SteadyState_OverNight(epcc_exps,inputs,iexp,model.par,Data.exp_data{1,iexp}(:,1)',Data.Initial_IPTG{1,iexp},Data.Initial_aTc{1,iexp});
end
...
inputs.PEsol.global_theta_min=[0.1386,5e-06,1e-3,7000,1,2,2,0.0165,1e-05,0.001,700,3.07e-4,2,2,1.32,1,0.001,0.001]; % verify Theta_T is correct 
inputs.PEsol.global_theta_max=[0.1386,10,1000,7000,100,4,4,0.0165,30,1000,700,3.07e-2,4,4,1320,1000,0.1,0.1]; % Maximum allowed values for the parameters
...
inputs.ivpsol.rtol=1e-5;                            % [] IVP solver integration tolerances
