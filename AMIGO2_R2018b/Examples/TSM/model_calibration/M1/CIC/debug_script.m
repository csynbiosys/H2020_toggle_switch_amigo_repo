...
epccOutputResultFileNameBase = [resultBase,'-',num2str(epcc_exps)];
    ...
    results_folder = strcat('M1-debug',datestr(now,'yyyy-mm-dd-HHMMSS'));
    ...
    %y0 =  M1_compute_steady_state(global_theta_guess,[50.61466259329, 158.608748834354],[0.20 25]); %[ToggleSwitch_M1_Compute_SteadyState(model.par,[1000,400],1,0) 0];
    y0=M1_Compute_SteadyState_OverNight(epcc_exps,inputs, exps.n_exp,global_theta_guess,[50.61466259329, 158.608748834354],[0.2 25]);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    inputs.exps.std_dev{1}=[0.025 0.025];
