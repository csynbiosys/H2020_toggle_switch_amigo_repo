function [out] = fit_to_M1_Step(epccOutputResultFileNameBase,epcc_exps,global_theta_guess)
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    short_name     = strcat('M1_CIC_Step',int2str(epcc_exps));
    ...
    y0 = M1_compute_steady_state(global_theta_guess,[50.61466259329, 158.608748834354],[0 25]); %[ToggleSwitch_M1_Compute_SteadyState(model.par,[1000,400],1,0) 0];
    ...
    dur = 100;                      % Duration of each step (minutes). Note that this value exceeds the response time, quantified in 80 mins for M1
    numCycles = duration/dur/2;     % Number of low-high cycles, corresponds to half of the number of steps
    inducer = [rand(1,2); randi([0 100],1,2)];  % Extract 2 random integer values from the Uniform distribution in (0,1000)uM to be used as low and high values in each cycle
