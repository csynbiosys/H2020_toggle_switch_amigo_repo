function [] = run_in_silico_experiment_parfor_IntuitionDriven_M1_pulse(resultBase, numExperiments )
...
parfor epcc_exps=1:numExperiments
        try
            ...
            [out] = fit_to_M1_Pulse(epccOutputResultFileNameBase,epcc_exps,global_theta_guess); % How uses the homovar data (5%)
            %[out] = fit_to_M1_Random(epccOutputResultFileNameBase,epcc_exps,global_theta_guess); % How uses the homovar data (5%)
