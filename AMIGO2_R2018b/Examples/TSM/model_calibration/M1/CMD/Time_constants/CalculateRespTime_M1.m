function [rise_times] = CalculateRespTime_M1(inputs,InitVals,theta)
...
ss_values = M1_compute_steady_state(theta, InitVals,inputs);
...
S=stepinfo(y,t,'RiseTimeLimits',[0.10 0.9],'SettlingTimeThreshold',0.005);
RTO1IP1=S(1,1).RiseTime;    RTO1IP2=S(1,2).RiseTime;
RTO2IP1=S(2,1).RiseTime;    RTO2IP2=S(2,2).RiseTime;

rise_times=[RTO1IP1 RTO2IP1 RTO1IP2 RTO2IP2];
