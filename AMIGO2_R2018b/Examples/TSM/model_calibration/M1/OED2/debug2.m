    ...
    % param_including_vector=[false,true,true,false,true,true,true,false,true,true,false,true,true,true,true,true,true,true];     % Excluding only those parameters from structural identifiability analysis
    param_including_vector=[false,true,false,false,true,true,true,false,true,false,false,true,true,true,false,false,true,true];
    ...
    totalDuration = 10*60;               % Duration in of the experiment (minutes)
...
for i=1:numLoops
    ...
    inputs.exps.u_min{iexp}(1,:)=0*ones(1,inputs.exps.n_steps{iexp});    % Lower boundary for IPTG
    inputs.exps.u_max{iexp}(1,:)=1*ones(1,inputs.exps.n_steps{iexp});  % Upper boundary for IPTG
    inputs.exps.u_min{iexp}(2,:)=0*ones(1,inputs.exps.n_steps{iexp});    % Lower boundary for LacI
    ...
    inputs.ivpsol.senssolver='fdsens5';                    % [] Sensitivities solver: 'cvodes'(default, C)| 'sensmat'(matlab)|'fdsens2'|'fdsens5'
