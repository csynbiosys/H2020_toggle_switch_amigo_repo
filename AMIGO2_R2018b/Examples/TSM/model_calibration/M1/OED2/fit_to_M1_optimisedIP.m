...
function [out]=fit_to_M1_optimisedIP(epccOutputResultFileNameBase,epccNumLoops,stepd,epcc_exps,global_theta_guess)
    ...
    % well. 
    param_including_vector=[false,true,true,false,true,true,true,false,true,false,false,true,true,true,true,true,true,true];
